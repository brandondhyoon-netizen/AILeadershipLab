...
:root{
  ...
  --font-body:'Apple SD Gothic Neo','Malgun Gothic','Noto Sans KR','Nanum Gothic',system-ui,-apple-system,sans-serif;
}
html,body{background:var(--bg);font-family:var(--font-body);color:var(--text);scroll-behavior:smooth;}
...
.btn-b{background:linear-gradient(135deg,#1D9BF0,#0EA5E9);border:none;border-radius:10px;color:white;cursor:pointer;font-family:var(--font-body);font-weight:600;padding:14px 32px;font-size:15px;transition:all .3s;box-shadow:0 4px 16px rgba(14,165,233,.25);}
...
.btn-g{background:linear-gradient(135deg,#FBBF24,#F59E0B);border:none;border-radius:10px;color:#0C1630;cursor:pointer;font-family:var(--font-body);font-weight:700;padding:16px 40px;font-size:16px;transition:all .3s;box-shadow:0 4px 16px rgba(251,191,36,.25);}
.btn-g:hover{transform:translateY(-2px);box-shadow:0 8px 28px rgba(251,191,36,.45);}
.btn-o{background:transparent;border:1px solid var(--bra);border-radius:10px;color:var(--mut);cursor:pointer;font-family:var(--font-body);font-weight:500;padding:14px 32px;font-size:15px;transition:all .3s;}
...
.ci{background:var(--card);border:1px solid var(--br);border-radius:10px;color:var(--text);font-family:var(--font-body);font-size:14px;line-height:1.5;outline:none;padding:12px 16px;resize:none;transition:border-color .2s;width:100%;}
.ci:focus{border-color:var(--blue);}
.ci::placeholder{color:var(--dim);}
.tab{background:transparent;border:1px solid var(--br);border-radius:8px;color:var(--dim);cursor:pointer;font-family:var(--font-body);font-size:13px;font-weight:500;padding:9px 18px;transition:all .2s;white-space:nowrap;}
            ...
            {[
              ...
              <button key={i} onClick={c.action} style={{display:"flex",alignItems:"center",gap:16,background:"rgba(29,155,240,.06)",border:"1px solid rgba(29,155,240,.2)",borderRadius:14,padding:"18px 20px",cursor:"pointer",textAlign:"left",transition:"all .25s",width:"100%"}}
                ...
                <div style={{flex:1}}>
                  ...
                  <div style={{fontSize:17,fontWeight:700,color:"var(--blue2)"}}>{c.value}</div>
